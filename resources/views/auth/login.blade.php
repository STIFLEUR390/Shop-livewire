							...
							<div class="login-form form-item form-stl">
								...
								<form name="frm-login" method="POST" action="{{ route('login') }}">
									...
									<fieldset class="wrap-title">
										<h3 class="form-title">Connectez-vous a votre compte</h3>
									</fieldset>
									<fieldset class="wrap-input">
										<label for="frm-login-uname">Address Email:</label>
										<input type="email" id="frm-login-uname" name="email" placeholder="Entrer votre address mail" :value="old('email')" required autofocus>
									</fieldset>
									<fieldset class="wrap-input">
									...
									<fieldset class="wrap-input">
										...
										<a class="link-function left-position" href="{{ route('password.request') }}" title="Forgotten password?">Mot de passe oublier?</a>
									</fieldset>
									<input type="submit" class="btn btn-submit" value="Connection" name="submit">
								</form>
							</div>
						</div>
