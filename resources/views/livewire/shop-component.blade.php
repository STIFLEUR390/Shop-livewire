        ...
        <div class="row">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-wish">
                                            @if ($witems->contains($product->id))
                                                <a href="javascript:void(0);" wire:click.prevent="removeFromWishlist({{$product->id}})"><i class="fa fa-heart fill-heart" aria-hidden="true"></i></a>
                                            @else
                                                <a href="javascript:void(0);" wire:click.prevent="addToWhishlist({{$product->id}}, '{{ $product->name }}', {{ $product->regular_price }})"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                                        ...
                                        <ul class="sub-cate">
                                            @foreach ($category->subCategories as $sub_category)
                                                <li class="category-item">
                                                    <a href="{{ route('product.category', ['category_slug' => $category->slug, 'scategory_slug' => $sub_category->slug]) }}" class="cat-link"><i class="fa fa-caret-right" aria-hidden="true"></i> {{ $sub_category->name }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    @endif
                ...
                <div class="widget mercado-widget filter-widget price-filter">
                    <h2 class="widget-title">Prix <span class="text-info">{{ priceFormat($min_price) }} - {{ priceFormat($max_price) }}</span> </h2>
                    <div class="widget-content">
