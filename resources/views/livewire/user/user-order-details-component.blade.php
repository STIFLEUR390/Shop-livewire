                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($order->status == 'ordered')
                                    <a href="javascript:void(0);" wire:click.prevent="cancelOrder" class="btn btn-warning pull-right mr-1">Cancel Order</a>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="products-cart">
                                @foreach ($order->orderItems as $item)
                                    <li class="pr-cart-item">
                                        ...
                                        <div class="price-field product-price"><p class="price">{{ priceFormat($item->price) }}</p></div>
                                        <div class="quantity">
                                            <h5>{{ $item->quantity }}</h5>
                                        </div>
                                        <div class="price-field sub-total"><p class="price">{{ priceFormat($item->price * $item->quantity) }}</p></div>
                                        @if ($order->status = 'delivered' && $item->rstatus == false)
                                            <div class="price-field sub-total"><p class="price"><a href="{{ route('user.review', $item->id) }}">Write Review</a></p></div>
                                        @endif
                                    </li>
                                @endforeach
                            </ul>
