                ...
                @foreach ($sliders as $slider)
                    <div class="item-slide">
                        ...
                        <div class="slide-info slide-1">
                            ...
                            <p class="sale-info">{{-- Only price --}}Au prix unique de: <span class="price">{{ priceFormat($slider->price) }}</span></p>
                            <a href="{{ $slider->link }}" class="btn-link">Acheter Maintenant</a>
                        </div>
                    </div>
                @endforeach
            </div>
                    ...
                    @foreach ($s_products as $product)
                        <div class="product product-style-2 equal-elem ">
                            ...
                            <div class="product-info">
                                ...
                                <div class="wrap-price"><ins><p class="product-price">{{ priceFormat($product->sale_price) }}</p></ins> <del><p class="product-price">{{ priceFormat($product->regular_price) }}</p></del></div>
                            </div>
                        </div>
                    @endforeach
                </div>
