            ...
            <div class="container">
                ...
                <div class="coppy-right-item item-right">
                    <div class="wrap-nav horizontal-nav">
                        <ul>
                            <li class="menu-item"><a href="javascript:void(0);" class="link-term">About us</a></li>
                            <li class="menu-item"><a href="javascript:void(0);" class="link-term">Privacy Policy</a></li>
                            <li class="menu-item"><a href="javascript:void(0);" class="link-term">Terms & Conditions</a></li>
                            <li class="menu-item"><a href="javascript:void(0);" class="link-term">Return Policy</a></li>
                        </ul>
                    </div>
                </div>
